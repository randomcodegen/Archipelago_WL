...
class WLLevel():
    ...
    def __init__(self, levelName: str, levelIDAddress: int, levelID: int, exit1Path: int = None, exit2Path: int = None):
...
full_level_list = [
    0x07, 0x0F, 0x0E, 0x0C, 0x19, 0x29,
    0x06, 0x10, 0x0D, 0x05, 0x11, 0x09, 0x0A,
    0x21, 0x02, 0x04, 0x08, 0x20, 0x18,
    0x03, 0x15, 0x16, 0x27, 0x1B, 0x1C,
    0x00, 0x1E, 0x1F, 0x0B, 0x14,
    0x26, 0x1D, 0x01, 0x13, 0x12, 0x1A,
    0x25, 0x22, 0x23, 0x28,
]
